(function (root, factory) {
  ...
  function proportionValue(rng) {
    const item = pick([
      { singular: "usine", plural: "usines", unit: "modèles", verb: "fabrique", pluralVerb: "fabriquent", pronoun: "elles" },
      { singular: "chaîne d'assemblage", plural: "chaînes d'assemblage", unit: "boîtiers", verb: "assemble", pluralVerb: "assemblent", pronoun: "elles" },
      { singular: "atelier", plural: "ateliers", unit: "pièces", verb: "produit", pluralVerb: "produisent", pronoun: "ils" },
      { singular: "capteur", plural: "capteurs", unit: "mesures", verb: "enregistre", pluralVerb: "enregistrent", pronoun: "ils" }
    ], rng);
